...
use ash::{
    ...
    vk::{
        ...
        PipelineStageFlags2, PresentInfoKHR, PresentModeKHR, Queue, Rect2D,
        RenderingAttachmentInfo, RenderingInfo, Semaphore, SemaphoreSubmitInfo, SubmitInfo2,
        SurfaceCapabilitiesKHR, SurfaceFormatKHR, SwapchainKHR, REMAINING_ARRAY_LAYERS,
...
impl VulkanApp {
    pub fn draw_gui(
        ...
        self.gui_parameters
            ...
            .unwrap()
            .prepare_frame(
                self.gui_parameters.context.as_mut().unwrap().io_mut(),
                window,
            )
